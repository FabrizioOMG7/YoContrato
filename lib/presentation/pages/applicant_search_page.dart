...
class _ApplicantSearchPageState extends State<ApplicantSearchPage> {
      ...
      SnackBar(
        content: Row(
          children: [
            ...
            Expanded(
              child: Text(
                'Postulante encontrado. Redirigiendo al formulario...',
              ),
            ),
          ],
        ),
  ...
  ApplicantSearchConfig _createSearchConfiguration() {
    return ApplicantSearchConfig(
      ...
      searchDescription:
          'Ingresa el DNI del candidato para iniciar el proceso de postulación',
      ...
      customValidation:
          _validateForApplicationContext, // Validaciones específicas
